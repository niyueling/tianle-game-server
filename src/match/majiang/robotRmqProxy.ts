...
export class MJRobotRmqProxy extends RobotRmqProxy {
  ...
  async playCard() {
    ...
    console.warn(`playerId: ${this.playerState.model.shortId}, name: ${this.playerState.model.nickname}, length: ${this.checkPlayerCount(this.playerState)}, redisKey: ${RedisKey.daPaiLock + this.playerState._id}, lock: ${JSON.stringify(lock)}`)
