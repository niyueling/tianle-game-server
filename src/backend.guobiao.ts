...
import MaJiangLobby from "./match/guobiao/centerlobby"
import {PublicRoom} from "./match/guobiao/publicRoom";
import Room from './match/guobiao/room'
...
const gameName = GameType.guobiao
